...
function CreateGeometries(){
	...
	SimulatorSetup.Joint41=new Joint(SimulatorSetup.glink4,SimulatorSetup.dummylinkend,l1, a1, z1, 0*Math.PI/2, 10,slidertube);
...
//	if (document.getElementById("toggle").checked==true ) {toggle=-1}
	...
	d=l3*l3-(l2*Math.sin(th4-th2)-l4)*(l2*Math.sin(th4-th2)-l4);
	if (d>0) {
		s41=l2*Math.cos(th4-th2)+toggle*Math.sqrt(d);
		th3=Math.atan2(s41*Math.sin(th4)-l2*Math.sin(th2)-l4*Math.cos(th4), s41*Math.cos(th4)-l2*Math.cos(th2)+l4*Math.sin(th4));
		th12=th2-th1;
		th23=th3-th12;
		th34=-Math.PI/2+th4-th3;
		th41=th1-th4;
		th25=th5+th23;
		...
		SimulatorSetup.Joint41.MoveJoint(s41,0);
...
function dCrankRotator12(theta) {
	var a, b, c;
	var th12, th23, th34, th41, th21;
